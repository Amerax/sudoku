...
At first the first few commits made the actual genertor and radomizer, and next then I made the actual player by moving and swapping some parts. 
 ...
 Otherwise, if you want to run from releases, open releases, and download the .class file. After that open command prompt and cd into the folder you saved the .class file to. Then simply run/type in "java SudokuGenerator" and it will start playing. Look at first demo image if you want to see me to do it. 
